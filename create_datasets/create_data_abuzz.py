...
X, y = get_data(target_names,'trainData_Abuzz.csv')
t_e = default_timer()
...
with open("train_abuzz.npy","wb") as f:
	np.save(f,data)

# Creating the test data file
t_s = default_timer()

X, y = get_data(target_names,'testData_Abuzz.csv')
t_e = default_timer()
...
with open("test_abuzz.npy","wb") as f:
	np.save(f,data)
